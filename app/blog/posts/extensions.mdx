...
- ⌘ + Shift + K = Delete Line
- ⌘ + D = Duplicate cursor to next occurrence
- ⌘ + K + P = Copy path of active file
- ⌘ + Opt + I (or Fn F12) = Inspect / Dev Console
- ⌘ + Shift + . = Toggle hidden files in Finder
- ⌘ + , = Open VS Code settings
- ⌘ + Shift + P = VS Code command window
- Window Positioning shortcuts (I have set to ⌘ + 1/2/3...)
