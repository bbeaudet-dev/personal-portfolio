...
<Image
  src="/images/errors-brackets.jpg"
...
Assign colors to individual folders/paths. Likely better for larger projects since it involves some manual setup. Here was my styling for the chatbot project:

<Image
  src="/images/folder-color.jpg"
...
The colors also apply to the file names and tabs on your VS Code windows, which is a game changer.
...
- Highly recommend BetterSnapTool (or Magnet, they're all the same imo) and configuring shortcuts for common layouts like left/right half, left/middle/right third, full screen, etc.

<Image
  src="/images/bettersnaptool.jpg"
...
- Option + Arrow = Move current line up/down
...
- Cmd + Opt + I or Fn F12 = Inspect / Dev Console
- Cmd + Shift + . (Period) = Toggle Hidden Files in Finder
- Cmd + Shift + P = VSCode command
