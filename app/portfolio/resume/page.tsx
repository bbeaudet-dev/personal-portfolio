...
export default function Resume() {
  return (
    <div className="min-h-screen print:bg-white print:py-0">
      <div className="max-w-4xl mx-auto print:max-w-none resume-zoom">
        {/* Print Button */}
        ...
        <CardContent className="p-8 print:p-4">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 mb-4 text-sm no-break avoid-break-after">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>Columbus, OH  /  New York, NY</span>
            </div>
            <div className="flex items-center gap-1">
          ...
          <section className="mb-2 print:break-inside-avoid avoid-break-before">
            ...
            <div className="mb-3">
              <div className="flex flex-wrap items-baseline justify-between gap-2 mb-0">
                <div className="flex flex-wrap items-baseline gap-2">
                  <h4 className="font-medium">Fullstack Software Engineer</h4>
                  <span className="text-muted-foreground">@</span>
                  <h5 className="text-muted-foreground">DigiYo</h5>
                </div>
              ...
              <ul className="list-disc list-outside ml-5 space-y-1 text-sm resume-bullets">
                <li>Rebuilt the codebase as a Convex-powered monorepo, shipped the app to Apple/Google Stores, and built a CI/CD pipeline spanning Linear, GitHub Actions, Convex, Vercel, and EAS with QR-preview testing</li>
                <li>Overhauled core user flows and app layout, including frictionless invites for new users and a TikTok-style Feed</li>
              </ul>
            </div>
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-outside ml-5 space-y-1 text-sm resume-bullets">
                <li>Built and deployed 20 full-stack apps, including an AI-powered smart mirror, interactive mobile puzzle game, image analysis and algorithm visualization tool, and riddlemaster-themed AI chatbot</li>
                <li>Ripped 933 GitHub commits and 239 PRs with 800+ hours of hands-on-keys in 12 weeks</li>
              </ul>
            </div>
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-outside ml-5 space-y-1 text-sm resume-bullets">
                <li>Implemented serial handshake protocol, Brainflow SDK integration, runtime-configurable board parameters, and O(n) ring buffer algorithm for robust and reliable EEG data transmission using an ESP32 and ADS1299 ADC</li>                
              </ul>
            </div>
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-outside ml-5 space-y-1 text-sm resume-bullets">
                  <li>Fulfilled 300+ sales orders for 75 global agencies, resulting in $3.5M in revenue</li>
                  <li>Created 400+ special trackwork drawings and BOMs and developed 7,500+ lines of CAD automation programs saving 3,000+ annual engineering hours</li>
              </ul>
            </div>
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-outside ml-5 space-y-1 text-sm resume-bullets">
                <li>Developed 10 portable kits for surgical device demos with an inventory of 150+ mechanical components</li>
                <li>Quantified cost savings with a cost-per-case analysis and oversaw manufacturing of first 10 production units</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-4 print:break-inside-avoid avoid-break-before">
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center gap-1.5">
                <h5 className="mr-2">AI:</h5>
                <Badge variant="skill">OpenAI API</Badge>
                <Badge variant="skill">Anthropic API</Badge>
                <Badge variant="skill">Amp (Sourcegraph)</Badge>
                <Badge variant="skill">Cursor</Badge>
                <Badge variant="skill">Claude Code</Badge>
                <Badge variant="skill">OpenClaw</Badge>
                <Badge variant="skill">Runway</Badge>
              </div>
              <div className="flex flex-wrap items-center gap-1.5">
                <h5 className="mr-2">Infra:</h5>
                <Badge variant="skill">Vercel / AI SDK</Badge>
                <Badge variant="skill">Cloudflare</Badge>
                <Badge variant="skill">AWS</Badge>
                <Badge variant="skill">GitHub Actions</Badge>
                <Badge variant="skill">Firebase</Badge>
                <Badge variant="skill">Resend</Badge>
              </div>
              <div className="flex flex-wrap items-center gap-1.5">
                <h5 className="mr-2">Hardware & CAD:</h5>
                <Badge variant="skill">Arduino</Badge>
                <Badge variant="skill">Raspberry Pi</Badge>
                <Badge variant="skill">SPI/I2C</Badge>
                <Badge variant="skill">Inventor</Badge>
          ...
          <section className="mb-4 print:break-inside-avoid avoid-break-before grid grid-cols-1 md:grid-cols-7 print:grid-cols-7 gap-2">
              ...
              <div className="space-y-2">
                ...
                <div>
                  <div className="flex flex-wrap items-baseline justify-between gap-x-2 gap-y-0 mb-0">
                    ...
                    <div className="text-muted-foreground text-sm whitespace-nowrap">Mathematics Minor · Cum Laude</div>
                  </div>
                  <div className="text-muted-foreground text-sm">Miami University · 2016-2020 · GPA: 3.68</div>
                  <div className="text-muted-foreground text-sm">Summer 2019 Capstone Project in London, UK</div>
                </div>
              </div>
            </div>
            <div className="md:col-span-3 print:col-span-3 pl-4">
              ...
              <ul className="list-disc list-outside ml-5 space-y-1 text-sm">
                ...
                <li>my mobile app for theatre enthusiasts</li>
                <li>mirror therapy and medical devices</li>
