...
<div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-8">
  <img
    src="/portfolio/birkdale/handshake1.jpeg"
    alt="Mirror therapy device prototype"
    className="rounded-lg shadow-md"
  />
  <img
    src="/portfolio/birkdale/handshake2.jpeg"
    alt="Device components and electronics"
    className="rounded-lg shadow-md"
  />
  <img
    src="/portfolio/birkdale/handshake3.jpeg"
    alt="Touch sensor integration"
    className="rounded-lg shadow-md"
  />
  <img
    src="/portfolio/birkdale/handshake4.jpeg"
    alt="Haptic feedback system"
    className="rounded-lg shadow-md"
  />
  <img
    src="/portfolio/birkdale/handshake5.jpeg"
    alt="Arduino board mounting"
    className="rounded-lg shadow-md"
  />
  <img
    src="/portfolio/birkdale/handshake6.jpeg"
