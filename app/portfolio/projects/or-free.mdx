...
tags: ["Mechanical"]
image: "/images-portfolio/lazurite/IMG_0550.jpg"
featured: 4
---
...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-8">
  <img
    src="/images-portfolio/lazurite/IMG_1127.jpg"
    alt="Portable surgery demonstration kit — Lazurite ArthroFree"
    className="rounded-lg shadow-md w-full object-cover aspect-[4/3]"
  />
  <img
    src="/images-portfolio/lazurite/IMG_1128.jpg"
    alt="Portable surgery demonstration kit — internal layout"
    className="rounded-lg shadow-md w-full object-cover aspect-[4/3]"
  />
  <img
    src="/images-portfolio/lazurite/IMG_0505.jpg"
    alt="Portable surgery demonstration kit — components and enclosure"
    className="rounded-lg shadow-md w-full object-cover aspect-[4/3]"
  />
</div>
