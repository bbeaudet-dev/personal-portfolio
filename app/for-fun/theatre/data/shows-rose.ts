...
function getImagePath(slug: string): string | null {
  const existingImages: Record<string, string> = {
    ...
    'all-in-a-comedy-about-love': '/images-theatre/all-in.jpg',
...
export const theatreShowListRose: TheatreShow[] = [
  ...
  { id: 16, slug: createSlug("Two Strangers Carry a Cake Across New York"), name: "Two Strangers Carry a Cake Across New York", rank: 17, visits: [], images: getImages('two-strangers-carry-a-cake-across-new-york') },
  ...
  { id: 31, slug: createSlug("Shucked"), name: "Shucked", rank: 32, visits: [], images: getImages('shucked') },
  { id: 32, slug: createSlug("Funny Girl"), name: "Funny Girl", rank: 33, visits: [], images: getImages('funny-girl') },
  { id: 33, slug: createSlug("Water for Elephants"), name: "Water for Elephants", rank: 34, visits: [], images: getImages('water-for-elephants') },
  { id: 34, slug: createSlug("Once Upon a Mattress"), name: "Once Upon a Mattress", rank: 35, visits: [], images: getImages('once-upon-a-mattress') },
  { id: 35, slug: createSlug("Beetlejuice"), name: "Beetlejuice", rank: 36, visits: [], images: getImages('beetlejuice') },
  { id: 36, slug: createSlug("Gutenberg! The Musical!"), name: "Gutenberg! The Musical!", rank: 37, visits: [], images: getImages('gutenberg') },
  { id: 37, slug: createSlug("On the 20th Century"), name: "On the 20th Century", rank: 38, visits: [], images: getImages('on-the-20th-century') },
  { id: 38, slug: createSlug("Back to the Future"), name: "Back to the Future", rank: 39, visits: [], images: getImages('back-to-the-future') },
  { id: 39, slug: createSlug("Dear Evan Hansen"), name: "Dear Evan Hansen", rank: 40, visits: [], images: getImages('dear-evan-hansen') },
  { id: 40, slug: createSlug("Mean Girls"), name: "Mean Girls", rank: 41, visits: [], images: getImages('mean-girls') },
  { id: 41, slug: createSlug("Oh, Mary!"), name: "Oh, Mary!", rank: 42, visits: [], images: getImages('oh-mary') },
  { id: 42, slug: createSlug("All in: A Comedy About Love"), name: "All in: A Comedy About Love", rank: 43, visits: [], images: getImages(createSlug("All in: A Comedy About Love")) },
  { id: 43, slug: createSlug("American Buffalo"), name: "American Buffalo", rank: 44, visits: [], images: getImages('american-buffalo') },
  { id: 44, slug: createSlug("Fat Ham"), name: "Fat Ham", rank: 45, visits: [], images: getImages('fat-ham') },
  { id: 45, slug: createSlug("The Last Five Years"), name: "The Last Five Years", rank: 46, visits: [], images: getImages('the-last-five-years') },
]
