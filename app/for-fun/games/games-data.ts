...
export const gamesData: GameData[] = [
  ...
  { slug: 'menagerie', title: 'Menagerie', images: ['/images-games/menagerie.jpg'], size: gameSizes['menagerie'], periods: ['teenager'], series: [{ title: 'Presentable Liberty' }, { title: 'Exoptable Money' }, { title: 'Archive' }] },
  ...
  { slug: 'minecraft', title: 'Minecraft', images: ['/images-games/minecraft.webp'], size: gameSizes['minecraft'], periods: ['teenager'] },
  { slug: 'skyrim', title: 'The Elder Scrolls V: Skyrim', images: ['/images-games/skyrim.jpg'], size: gameSizes['skyrim'], periods: ['teenager'] },
  ...
  { slug: 'spyro-trilogy', title: 'Spyro the Dragon Trilogy', images: ['/images-games/spyro-reignited-trilogy.jpeg'], size: gameSizes['spyro-trilogy'], periods: ['childhood'] },
  ...
  { slug: 'crash-bash', title: 'Crash Bash', images: ['/images-games/crash-bash.jpg'], size: gameSizes['crash-bash'], periods: ['childhood'] },
